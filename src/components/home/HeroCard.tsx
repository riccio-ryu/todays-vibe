    ...
    return (
      <div className={cardClass}>
        ...
        <div className="relative px-4 py-6 sm:px-6 sm:py-10 text-center">
          ...
          <h3 className="cosmic-text font-medium text-xl mb-1">오늘의 기운이 도착했어요</h3>
    ...
    return (
      <div className={cardClass}>
        ...
        <div className="relative px-4 py-6 sm:py-10 text-center">
          <div className="text-4xl sm:text-5xl mb-3 sm:mb-4 animate-pulse">{moon.emoji}</div>
          <p className="text-[#a8a6b7] text-sm">기운을 받는 중...</p>
        </div>
      </div>
    );
  }
    ...
    <div className={cardClass}>
      ...
      <div className="relative px-4 py-5 sm:px-5 sm:py-6">
        ...
        <div className="text-center mb-5">
          ...
          <h3 className="text-[#f4f0ff] font-medium text-base">
            {moon.name}·{MOON_ENERGY[moon.name] ?? "오늘의 기운"}
          </h3>
          <p className="text-[#a8a6b7]/60 text-xs mt-0.5">{dateKo}</p>
        </div>
        ...
        {/* 메시지 */}
        {message && (
          <p className="text-[#a8a6b7] text-sm text-center leading-relaxed mb-4 px-2">
            &ldquo;{message}&rdquo;
          </p>
        )}
        ...
        {state === "ready" && (
          <div className="border-t border-white/6 pt-4">
            <p className="text-[#a8a6b7]/60 text-xs text-center mb-3">이 기운을 더 깊이 읽어볼까요?</p>
        ...
        <p className="text-[#a8a6b7]/40 text-xs text-center mt-3">⏰ 다음 기운은 내일 받을 수 있어요</p>
      </div>
    </div>
  );
}
