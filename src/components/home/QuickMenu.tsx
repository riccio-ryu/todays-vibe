      ...
      >
        {items.map((item) => (
          <Link
            key={item.id}
            href={item.path}
            className="group flex flex-col items-center gap-1.5 py-3.5 px-2 rounded-xl bg-white/5 border border-white/8 hover:bg-[#9382ff]/8 hover:border-[#9382ff]/20 hover:-translate-y-0.5 transition-all duration-200"
          >
